    ...
    <>
      ...
      <header className="md:hidden">
        <div className="relative h-screen">
          ...
          {navBar && (
            <div className="inset-y-0 left-0 w-20 h-screen bg-muted">
      ...
      {/* Desktop Nav */}
      <header
        className={`hidden md: md:w-[25%] h-screen bg-background md:flex flex-col items-center gap-y-20  text-foreground border-l-[1px] border-r-[1px] ${
